...
#include "create_dynamic_message.h"
...
public:
  ...
  bool parseInto(std::string text_format, google::protobuf::MessageLite* msg,
...
private:
  ...
  createEmptyDynamicMessage(std::string type_name,
                            google::protobuf::io::ErrorCollector* error_collector) const;

  bool toBinarySerializationInternal(std::string type_name,
