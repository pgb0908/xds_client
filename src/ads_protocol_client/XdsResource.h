...
#ifndef XDS_CLIENT_XDSRESOURCE_H
#define XDS_CLIENT_XDSRESOURCE_H
...
public:
     ...
     */
    static xds::core::v3::ResourceName decodeUrn(std::string resource_urn);
     ...
     * @throws EnvoyException when parsing fails.
     */
    static xds::core::v3::ResourceLocator decodeUrl(std::string resource_url);

    /**
     * @param resource_name resource name.
     * @return bool does resource_name have a xdstp: scheme?
     */
    static bool hasXdsTpScheme(std::string resource_name);
};


#endif //XDS_CLIENT_XDSRESOURCE_H
