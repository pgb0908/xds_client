...
public:
   ...
   */
  virtual void update(const absl::flat_hash_set<std::string>& resources) = 0;
};
...
public:
   ...
   */
  ABSL_MUST_USE_RESULT virtual ScopedResume pause(const std::string& type_url) = 0;
   ...
   * A discovery request will be sent if one would have been sent during the pause.
   */
  ABSL_MUST_USE_RESULT virtual ScopedResume pause(const std::vector<std::string> type_urls) = 0;
   ...
   */
  //virtual EdsResourcesCacheOptRef edsResourcesCache() = 0;
};
